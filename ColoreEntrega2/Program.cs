...
//Conexão online
builder.Services.AddDbContext<Conexao>(options => options.UseSqlServer(@"Data Source=tcp:coloreentrega2dbserver.database.windows.net,1433;Initial Catalog=ColoreEntrega2_db;User Id=julianamesquita@coloreentrega2dbserver;Password=124578colore"));
